...
class OculusDevice : public osg::Referenced
{
    ...
    public:
        ...
        void updateHMDPosition(QVector3D pos);
        void updateHMDRotation(QQuaternion quat);
        void useArtTracking(bool tmp = true) { useartdata = tmp; }
        bool artTracking() { return useartdata; }
